          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <BreezeNavLink :href="route('dashboard')"> Menu </BreezeNavLink>
                <BreezeNavLink :href="route('dashboard')"> Blog </BreezeNavLink>
            ...
            <div class="flex">
              <!-- Language Selector -->
              <div class="hidden ml-3 items-center relative space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <BreezeDropdown align="right" width="12">
                  ...
                  <template #content>
                    <BreezeDropdownLink> en </BreezeDropdownLink>
                    <BreezeDropdownLink> ar </BreezeDropdownLink>
                  </template>
                </BreezeDropdown>
                <!-- Auth -->
