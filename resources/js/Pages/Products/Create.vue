            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form @submit.prevent="submit">
                        ...
                        <div class="grid md:grid-cols-2 gap-2">
                            <div>
                                <select
                                    ...
                                    :class="{ 'text-gray-500': !form.cat_id, 'select-error': $page.props.errors.cat_id }"
                                    v-model="form.cat_id"
                                    autocomplete="cat_id"
                                >
                        ...
                        <div class="grid grid-cols-2 gap-2 my-2 mt-3">
                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="6">
                                        <div class="flex justify-center bg-almond-600 rounded">box</div>
                                    </th>
                                    <th colspan="6">
                                        <div
                                            class="flex justify-center bg-almond-600 rounded"
                                        >package</div>
                                    </th>
                                    <th></th>
                                </tr>
